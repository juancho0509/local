...
public class Administrador extends javax.swing.JFrame {
    ...
    public Administrador() {
        ...
        ImageIcon wallpaper = new ImageIcon("src/images/nuevo wallpaper");
    ...
    private void initComponents() {
        ...
        jButton_RegistrarUsuario.setOpaque(false);
        ...
        jButton_Creatividad.setBorderPainted(false);
        jButton_Creatividad.setContentAreaFilled(false);
        ...
        jButton_AcercaDe.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/logo ingetec 80.png"))); // NOI18N
        ...
        getContentPane().add(jButton_AcercaDe, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 226, 133, 114));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(265, 170, -1, -1));

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Creatividad");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(515, 170, -1, -1));

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Panel vista capturista");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 340, -1, -1));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(266, 380, -1, 38));
